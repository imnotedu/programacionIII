...
const poolConfig = env_1.config.databaseUrl
    ? { connectionString: env_1.config.databaseUrl, ssl: { rejectUnauthorized: false } }
    : {
        user: env_1.config.dbUser,
        host: env_1.config.dbHost,
        database: env_1.config.dbName,
        password: env_1.config.dbPassword,
        port: env_1.config.dbPort,
    };
...
async function createSuperAdmin() {
    try {
        ...
        // Crear superadmin
        const passwordHash = await (0, auth_1.hashPassword)('1234567');
